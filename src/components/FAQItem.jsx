  ...
  return (
    <div className="card p-5 border-brand-blue/30 bg-brand-blue/10 backdrop-blur-md transition-all hover:bg-brand-blue/20">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-sm font-black text-[#062d78] group-hover:text-brand-blue transition-colors">{question}</span>
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <p className="mt-3 text-sm text-[#083796] font-bold leading-relaxed">{answer}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
