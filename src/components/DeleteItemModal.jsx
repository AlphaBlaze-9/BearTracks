...
export default function DeleteItemModal({ isOpen, onClose, onConfirm, loading, itemTitle }) {
    return (
        <AnimatePresence>
            {isOpen && (
                <>
                        ...
                        >
                            <div className="p-8 text-center">
                                ...
                                <p className="mt-4 text-slate-400 leading-relaxed">
                                    Are you sure you want to delete <span className="text-white font-semibold">"{itemTitle}"</span>? This action is permanent and cannot be undone.
                                </p>
