// Hero.jsx: Landing section displayed at the top of the BearTracks homepage.
// Features a two-column layout — left: headline, tagline, and CTA buttons;
// right: a glass card showing example "latest finds" to illustrate the product.
// Background uses layered radial gradients and blurred blob divs for visual depth.
// All Framer Motion animations respect the OS prefers-reduced-motion preference.
...
export default function Hero() {
  // prefersReducedMotion: when true, all motion props are set to undefined/false
  // so Framer Motion renders elements in their final position without animating.
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      {/* ── Background Layer ──────────────────────────────────────────── */}
      {/* Linear gradient darkens toward the bottom to blend into the main content */}
      <div className="absolute inset-0 bg-gradient-to-b from-brand-blue/30 via-slate-950 to-slate-950" />
      {/* Radial gradient overlay adds three distinct glow sources for visual richness */}
      ...
      {/* These are purely visual — pointer-events-none ensures they never intercept clicks */}
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-20 md:px-6 md:py-28">
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div>
            {/* Bear Tracks logo — scale animation on mount (skipped if reduced motion) */}
            <motion.div
            ...
            {/* Tagline pill — subtle brand-gold dot signals "live / active" */}
            <motion.p
            ...
            {/* Headline — delay: 0.05s staggers it after the tagline */}
            <motion.h1
            ...
            {/* Supporting copy — delay: 0.1s for natural reading cascade */}
            <motion.p
              initial={prefersReducedMotion ? false : { opacity: 0, y: 14 }}
              animate={prefersReducedMotion ? undefined : { opacity: 1, y: 0 }}
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {/* Primary CTA: scrolls the page to the #cta anchor on the same page */}
              <motion.a
                href="#cta"
              ...
              {/* Secondary CTA: scrolls to the features / how-it-works section */}
              <a
                href="#features"
            ...
            {/* ── Trust Indicators ─────────────────────────────────────── */}
            {/* Three icon + label pairs that reinforce key product benefits at a glance */}
          ...
          {/* ── Right Column: "Latest Finds" Glass Card ───────────────── */}
          {/* Demo card showing how recent items appear — helps visitors understand the product */}
          <motion.div
          ...
          >
            ...
            {/* Example items — each staggered by 60ms for a cascading entrance */}
            <div className="mt-6 space-y-3">
              {[
                ...
                >
                  {/* Category icon in a glass circle */}
            ...
            {/* ── Pro Tip Banner ────────────────────────────────────────── */}
            {/* Warm gold gradient reinforces the brand and draws the eye */}
